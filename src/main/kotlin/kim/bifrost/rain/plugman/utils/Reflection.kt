package kim.bifrost.rain.plugman.utils
...
class ReflectClass(val clazz: Class<*>) {
    ...
    companion object {
        ...
        private val savingNormalClazz = ConcurrentHashMap<String, Class<*>>()
        ...
        fun find(name: String): ReflectClass? {
            val clazz = savingNormalClazz[name] ?: Class.forName(name) ?: return null
            return find(clazz)
        }
    }
}